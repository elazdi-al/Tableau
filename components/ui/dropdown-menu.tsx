...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground/70 ml-auto text-xs font-medium bg-muted/30 px-1 py-0.5 rounded text-[10px]",
        className
      )}
      {...props}
    />
